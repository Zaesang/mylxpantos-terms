...
### 제 1 조 - 목적
본 약관은 주식회사 엘엑스판토스(이하 “회사”)가 제공하는 [MY PANTOS] 서비스(이하  “서비스”) 이용과 관련하여 회사와 회원 간 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.

### 제 2 조 - 약관의 효력 및 변경
1.	회사는 본 약관의 내용을 서비스 웹사이트(www.mylxpantos.com)에 항시 게시합니다.
...
### 제 4 조 - 정의
1.	서비스: [MY PANTOS]를 통해 국제운송 및 내륙운송(출발지, 도착지), 통관, 보험 등 진행하는 모든 서비스를 의미합니다.
* I.	국제운송: 회원이 요청한 선사를 사용하여 회원이 원하는 도착지 Port까지 화물을 배송 시키는 단계
* II.	내륙운송(출발지, 도착지): 
...
2.	회사가 제공하는 서비스의 내용을 기술적 사양의 변경 등의 이유로 변경할 경우에는 그 사유를 회원에게 통지하거나, 회원이 알아볼 수 있도록 서비스 웹사이트에 공지사항으로 게시합니다.
...
2)&nbsp;회사가 해지를 하는 경우 회사는 회원에게 이메일, 전화, 기타의 방법을 통하여 해지 사유를 밝혀 해지 의사를 통지합니다. 이용계약은 회사의 해지 의사를 회원에게 통지한 시점에 종료됩니다.
...
1.	국제운송(내륙운송 포함) 서비스는 회사가 회원들로부터 화물의 정보, 운송구간의 물류 용역 정보를 수취해 요청한 내용을 가지고 정확하고 신속하게 선복 및 배차를 확보하여 운송이 이루어질 수 있도록 하는 것입니다.
2.	국제운송 조회 서비스는 회사가 회원들로부터 수취한 요청 정보를 가지고 선복을 확보한 후 그에 해당하는 모든 정보 (요청내역, 모선정보, 출/도착일, 카고/서류 마감기한, 컨테이너 픽업/반입지 등)를 화주에게 제공하는 것입니다.
3.	견적/부킹(booking) 서비스는 회사가 회원들로부터 수취한 정보를 가지고 선복을 확보하여 운송이 이루어질 수 있도록 하는 것입니다.
...
### 제12조 – 개별계약 
1.	회원은 서비스 웹사이트에서 예상 요금(견적)을 확인한 후 예약(booking)을 요청할 수 있으며 회원의 요청에 따라 회사가 예약 내용을 확정하면 개별계약이 체결됩니다. 
2.	회사는 회원의 요청사항이 다음 각 호에 해당하는 경우 서비스의 제공을 거부할 수 있습니다. 
가. 신청 내용에 허위, 기재누락, 오기가 있는 경우 
나. 회원이 관련 법령 및 동 약관에서 금지하는 재화에 대해 수출대행 또는 운송을 요청하는 경우 
다. 무게 등 기타 조건에 의하여 배송에 현저히 지장이 있다고 판단하는 경우 
...
가. 부가비용이란 서비스 이용요금인 항공/해운 운송료 이외 부가적으로 발생되는 비용으로 목적지국에서 부과되는 관세, 세금 및 규격할증료 등 기타 추가 발생되는 비용을 의미합니다. 
5.	외화로 고지된 운임을 사용하는 경우, 환율은 [개별 계약건 실출항일 기준]으로 [KEB하나은행이 고시한 환율]을 적용합니다.
